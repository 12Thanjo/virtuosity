		...
		return {
			...
			delete: {
				...
				shape: (name, container)=>{
					return container_check(container, (cntnr)=>{
						cntnr.shapes.get(`${name}╎${container}`).pixi.destroy();
					});	
				}
			},
