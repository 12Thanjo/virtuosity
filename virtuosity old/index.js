...
* @name virtuosity
* @type head
* @description Virtuosity is a free, open source game engine that is puts all of the systems that I have built / found together in one easy place. It is designed to make game development faster and easer by automatically doing all of the annoying stuff. Virtuosity is designed for the intended use in <a href="https://www.electronjs.org/">Electron</a>.<h4>Rendering</h4><p>Virtuosity uses <a href="https://www.npmjs.com/package/babylonjs">Babylonjs 4.1</a> for 3d rendering and <a href="https://www.npmjs.com/package/phaser-ce">Phaser-CE 2.15.1</a> for 2d rendering. Phaser 3.x is more feature rich and suposedly performs better, however it is not equiped for some features that are neccesary for Virtuosity. Phaser-CE is still getting support as well.</p>
*/
