class Heap{
	...
	* @name size
	* @type method
	* @description get the size of the heap
	*/
	size = function(){
	...
	* @name push
	* @type method
	* @description add a value to the heap
	* @param {val}{Number}{vale to add to the heap}
	*/
	push = function(val){
	...
	* @name print
	* @type method
	* @description print the array of the heap
	*/
	print = function(){
		return this.#arr;
	}
	...
	* @name pop
	* @type method
	* @description get and remove the lowest value
	*/
	pop = function(){
